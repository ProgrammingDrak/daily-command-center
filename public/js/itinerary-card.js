    ...
    el.innerHTML=
      ...
      '<div class="card-wrap">'+
        ...
        '<div class="card'+(active?' card-active':'')+(isBounty?' card-bounty':'')+(bountyMeta.hasSponsor?' card-bounty-sponsor':'')+'"'+(bountyMeta.hasSponsor?' title="'+bountySponsorTitle+'"':'')+'>'+
          ...
          (guest?'':(!isMeeting(ev)?'<button class="btn-task-radial" data-radial-id="'+ev.id+'" data-tooltip="More: subtask · repeat · delegate · backlog" aria-label="More task actions: make subtask, repeat responsibility, delegate/block, move to backlog"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="5" r="1.4"/><circle cx="12" cy="12" r="1.4"/><circle cx="12" cy="19" r="1.4"/></svg></button>':''))+

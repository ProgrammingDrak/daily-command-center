...
(function(){
  ...
  function gbPages(current){
    ...
    // "day-review" is a RETIRED id, not a live page. The nightly scan that produced it
    // was ripped out 2026-08-20, but rows written before then still carry the page in
    // their stored packet, so it stays filtered here rather than rendering as a raw JSON
    // dump. Do not remove this until those rows have aged out.

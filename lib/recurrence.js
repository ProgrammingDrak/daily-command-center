...
function resolveInstanceState({ instanceBlock, dayRootProps, keys, instanceDate, todayStr }) {
  ...
  // Row-level done. Written today by the quick-task and Slack-timer paths, and
  // by everything once C5 lands.
  ...
  // Day-overlay done. This is the one that catches toggleDone,
  // _autoCompleteShellAncestors (every shell responsibility -- the big miss),
  // commitDoneOnDate/markOnDate, and the _onParentCompleted cascade.
